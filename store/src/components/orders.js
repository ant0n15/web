...
const Orders = ({ data, customer_data, product_data }) => {
    return (
    <div>
        <div className="header">Orders List</div>
            ...
            <div key={item._id} className="card">
                <div className="left">
                    <div className="card-body">
                        ...
                        <p className="card-text">Address: {customer_data[0].address}</p>
                ...
                <Button className="btn" variant="contained" color="primary">Confirm</Button>
